...
import org.crimsoncrips.craftorio.client.screen.purchase.CatalogScreen;
...
public class ContractCreatorItemBrowserScreen extends CatalogScreen<ItemStack> {
    ...
    public ContractCreatorItemBrowserScreen(Screen parent) {
    ...
    private class BrowseEntryButton extends AbstractButton {
        ...
        BrowseEntryButton(int x, int y, ItemStack stack) {
            ...
            this.setTooltip(Tooltip.create(this.displayStack.getHoverName()));
        }
