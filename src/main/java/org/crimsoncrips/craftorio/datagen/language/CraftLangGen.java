...
public class CraftLangGen extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		this.addMisc("contract_creator_details_title", "Contract Creator - Properties");
		...
		this.addMisc("dev_tools_contract_region_title", "Title");
		this.addMisc("dev_tools_contract_region_time", "Time");
		this.addMisc("dev_tools_contract_region_description", "Description");
		this.addMisc("dev_tools_contract_region_punishment", "Punishment");
		this.addMisc("dev_tools_contract_region_min", "Offer Min Points");
		this.addMisc("dev_tools_contract_region_threshold", "Claim Threshold");
		this.addMisc("dev_tools_contract_region_max", "Offer Max Points");
		this.addMisc("dev_tools_contract_region_min_short", "Min");
		this.addMisc("dev_tools_contract_region_threshold_short", "Claim");
		this.addMisc("dev_tools_contract_region_max_short", "Max");
		this.addMisc("dev_tools_contract_time_convert", "Hours / Minutes");
		this.addMisc("dev_tools_label_text_color", "Text Color (Opt)");
		this.addMisc("dev_tools_contract_color_reset", "Reset");
		this.addMisc("dev_tools_contract_no_punishment", "No Punishment");
		this.addMisc("dev_tools_contract_card_hint", "Click to edit the contract's properties");
		this.addMisc("dev_tools_contract_item_requirements", "Item Requirements");
		this.addMisc("dev_tools_contract_item_rewards", "Item Rewards");
		this.addMisc("dev_tools_clear_page", "Clear Page");
		this.addMisc("dev_tools_page", "Page %s / %s");
		this.addMisc("dev_tools_contract_help_regions", "Click the box to slide out its values and text color. Click bottom boxes to type the value in place");
		this.addMisc("dev_tools_contract_help_card", "Click anywhere else on the card for the other stats.");
		this.addMisc("dev_tools_contract_help_colors", "Text colors are optional. Leave the box empty (or press Reset) to keep the default color");
		this.addMisc("dev_tools_pick_upgrade_manual", "Manual upgrade, can't be edited here");
		this.addMisc("dev_tools_pick_upgrade_help_1", "Click an upgrade to load it into the Upgrade Creator. Right-click drag to pan the canvas.");
		...
		this.addMisc("dev_tools_label_id", "Id");
		...
		this.addMisc("dev_tools_label_punishment", "Punishment ID (Opt)");
