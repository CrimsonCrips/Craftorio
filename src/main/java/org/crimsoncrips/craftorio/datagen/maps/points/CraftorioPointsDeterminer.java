...
public class CraftorioPointsDeterminer extends DataMapProvider {
    ...
    protected void gather() {
        ...
        CraftorioAdvancementMultDeterminer.advancementMultiplierMap(multiplierValue);
    }
    ...
    protected void advancementMap() {
        ...
        addAdvancementValue(point_value, "adventure/adventuring_time", 500);
        addAdvancementValue(point_value, "adventure/arbalistic", 400);
        addAdvancementValue(point_value, "adventure/bullseye", 350);
        addAdvancementValue(point_value, "adventure/hero_of_the_village", 300);
        addAdvancementValue(point_value, "adventure/honey_block_slide", 130);
        addAdvancementValue(point_value, "adventure/kill_all_mobs", 600);
        addAdvancementValue(point_value, "adventure/kill_a_mob", 100);
        addAdvancementValue(point_value, "adventure/ol_betsy", 110);
        addAdvancementValue(point_value, "adventure/shoot_arrow", 100);
        addAdvancementValue(point_value, "adventure/sleep_in_bed", 100);
        addAdvancementValue(point_value, "adventure/sniper_duel", 250);
        addAdvancementValue(point_value, "adventure/summon_iron_golem", 150);
        addAdvancementValue(point_value, "adventure/throw_trident", 130);
        addAdvancementValue(point_value, "adventure/totem_of_undying", 200);
        addAdvancementValue(point_value, "adventure/trade", 110);
        addAdvancementValue(point_value, "adventure/two_birds_one_arrow", 350);
        addAdvancementValue(point_value, "adventure/very_very_frightening", 300);
        addAdvancementValue(point_value, "adventure/voluntary_exile", 200);
        addAdvancementValue(point_value, "adventure/whos_the_pillager_now", 120);
        addAdvancementValue(point_value, "end/dragon_breath", 250);
        addAdvancementValue(point_value, "end/dragon_egg", 350);
        addAdvancementValue(point_value, "end/elytra", 400);
        addAdvancementValue(point_value, "end/enter_end_gateway", 220);
        addAdvancementValue(point_value, "end/find_end_city", 350);
        addAdvancementValue(point_value, "end/kill_dragon", 500);
        addAdvancementValue(point_value, "end/levitate", 400);
        addAdvancementValue(point_value, "end/respawn_dragon", 450);
        addAdvancementValue(point_value, "husbandry/balanced_diet", 600);
        addAdvancementValue(point_value, "husbandry/bred_all_animals", 450);
        addAdvancementValue(point_value, "husbandry/breed_an_animal", 100);
        addAdvancementValue(point_value, "husbandry/complete_catalogue", 500);
        addAdvancementValue(point_value, "husbandry/fishy_business", 110);
        addAdvancementValue(point_value, "husbandry/obtain_netherite_hoe", 250);
        addAdvancementValue(point_value, "husbandry/plant_seed", 100);
        addAdvancementValue(point_value, "husbandry/safely_harvest_honey", 130);
        addAdvancementValue(point_value, "husbandry/silk_touch_nest", 200);
        addAdvancementValue(point_value, "husbandry/tactical_fishing", 250);
        addAdvancementValue(point_value, "husbandry/tame_an_animal", 120);
        addAdvancementValue(point_value, "nether/all_effects", 600);
        addAdvancementValue(point_value, "nether/all_potions", 450);
        addAdvancementValue(point_value, "nether/brew_potion", 140);
        addAdvancementValue(point_value, "nether/charge_respawn_anchor", 180);
        addAdvancementValue(point_value, "nether/create_beacon", 300);
        addAdvancementValue(point_value, "nether/create_full_beacon", 700);
        addAdvancementValue(point_value, "nether/distract_piglin", 130);
        addAdvancementValue(point_value, "nether/explore_nether", 350);
        addAdvancementValue(point_value, "nether/fast_travel", 450);
        addAdvancementValue(point_value, "nether/find_bastion", 200);
        addAdvancementValue(point_value, "nether/find_fortress", 200);
        addAdvancementValue(point_value, "nether/get_wither_skull", 350);
        addAdvancementValue(point_value, "nether/loot_bastion", 220);
        addAdvancementValue(point_value, "nether/netherite_armor", 400);
        addAdvancementValue(point_value, "nether/obtain_ancient_debris", 250);
        addAdvancementValue(point_value, "nether/obtain_blaze_rod", 220);
        addAdvancementValue(point_value, "nether/obtain_crying_obsidian", 170);
        addAdvancementValue(point_value, "nether/return_to_sender", 200);
        addAdvancementValue(point_value, "nether/ride_strider", 150);
        addAdvancementValue(point_value, "nether/summon_wither", 400);
        addAdvancementValue(point_value, "nether/uneasy_alliance", 500);
        addAdvancementValue(point_value, "nether/use_lodestone", 130);
        addAdvancementValue(point_value, "story/cure_zombie_villager", 350);
        addAdvancementValue(point_value, "story/deflect_arrow", 150);
        addAdvancementValue(point_value, "story/enchant_item", 150);
        addAdvancementValue(point_value, "story/enter_the_end", 400);
        addAdvancementValue(point_value, "story/enter_the_nether", 220);
        addAdvancementValue(point_value, "story/follow_ender_eye", 250);
        addAdvancementValue(point_value, "story/form_obsidian", 130);
        addAdvancementValue(point_value, "story/iron_tools", 120);
        addAdvancementValue(point_value, "story/lava_bucket", 120);
        addAdvancementValue(point_value, "story/mine_diamond", 200);
        addAdvancementValue(point_value, "story/mine_stone", 100);
        addAdvancementValue(point_value, "story/obtain_armor", 110);
        addAdvancementValue(point_value, "story/shiny_gear", 280);
        addAdvancementValue(point_value, "story/smelt_iron", 110);
        addAdvancementValue(point_value, "story/upgrade_tools", 100);
    }
    ...
    protected void itemMap() {
        ...
        addItemValue(point_value, Items.PLAYER_HEAD.builtInRegistryHolder(), 3000,0);
        ...
        CraftorioExternalPointsDeterminer.addExternalValues(point_value);
    }
